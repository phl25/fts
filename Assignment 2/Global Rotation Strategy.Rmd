...
The results of the strategy's risk analysis indicate that no excess returns are generated. The intercept of the regression models (CAPM as well as Fama-French model) is negative and not significant. This means that risk adjusted and compared to the market we cannot generate an alpha (excess returns). However, the beta-coefficient for the market risk free return is significant and with about 0.68 below 0. Thus, the strategy is not significantly market sensitiv.
...
## Conclusion
The Global Rotation Strategy in its plain generates 7% annulaized return while the compared buy and hold strategy generates about 6%. The Sharp Ratio for the strategy is 0.48 compared to 0.43 for the buy and hold strategy. As we saw, the risk analysis has shown that we cannot generate excess returns with this strategy compared to the market. Especially after 2009 the strategy does not generate enough returns to outperform the buy and hols strategy. In fact, after 2009 the returns of the strategy are not significantly positive. The following chapters describe improvement options for the strategy, in order to increase the returns and the performance, especially for the time horizon after the GFC.
...
The improved strategy's risk analysis shows that we can generate excess risk adjusted returns. The intercept of the regression is in both tested models (CAPM and Fama-French Model) significant and positive with about 0.1. This leads to a risk-adjusted outperformance of about 0.1*12 = 1.2% per year. 
...
The relative performance of the V3 strategy compared to the V2 strategy shows that especially during the financial crisis the strategy which included short-selling outperformed the GRS.V2 strategy. 
...
The analysis of the improved V3 strategy's risk shows again what we have seen with the V2 improvement strategy. We can generate a significant alpha of approx. 0.1 and by this generate risk adjusted excess returns. 
