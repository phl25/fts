...
To make sure that our system worked properly some transactions were observed to make sure that the trades were performed according to the defined rules. Prepare the chart. Check 4 transactions. Visualize the charts with the transactions which should be checked.
