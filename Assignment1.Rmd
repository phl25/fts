...
Plot of the instrument with the EMA line which indicates the general trend of the stock exponentially smoothed for the last 200 days. Moreover, the tradevolume is added below the graph. THIS FUNCTION DOES NOT WORK IN A FOR LOOP
```{r message=FALSE, echo=FALSE}
for (instrument in instrumentlist){
...
To make sure that our system worked properly some transactions were observed to make sure that the trades were performed according to the defined rules. Prepare the chart. Check 4 transactions.
